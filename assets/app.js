...
const FIREBASE_CONFIG = {
  apiKey: "AIzaSyA0RLyC3aPhYztjv5deaFMTNmLp8jtQuW8",
  authDomain: "simps-wiki.firebaseapp.com",
  databaseURL: "https://simps-wiki-default-rtdb.firebaseio.com",
  projectId: "simps-wiki",
  storageBucket: "simps-wiki.firebasestorage.app",
  messagingSenderId: "926874656840",
  appId: "1:926874656840:web:18fe816ed1a7011ac1f87d",
};
// Example:
// const FIREBASE_CONFIG = {
//   apiKey: "AIza...",
...
(async function(){
	...
	const LORE_DEFAULTS = {
		...
		'bessie-the-cow-mind-enslaving-milk': `Bessie the Cow's milk enslaves minds. This is not a minor side effect or an occasional occurrence — it is the central mechanic of Bessie's power. The milk is the weapon. Bessie (#41) is otherwise a standard cow, which makes the mind-enslaving milk more alarming, not less, because nobody suspects the cow.`,
		...
		'witch-willifred-curses-you-to-get-smaller-as-you-age': `Witch Willifred (#78) curses you to get smaller as you age. The curse is specific, slow-acting, and eventually decisive. Willifred is also the entity who defeats Dwayne the Rock Johnson for image rights (#80), which establishes a precedent: she wins fights that look unwinnable. Do not underestimate her based on the aging mechanic.`,
		...
		'salamandra-small-but-immortal': `Salamandra (#102) is small but immortal. The parenthetical is the key fact: the size is irrelevant. Immortality means all encounters with Salamandra are effectively one-sided in the long run. She may lose individual battles. She will not lose the war. The small size just makes her harder to find.`,
		...
		'vivi-lafont-who-must-save-the-world-in-five-steps': `Vivi LaFont (#117) must save the world in five steps. The constraint is the character: she has exactly five moves available, and the world is at stake, and she knows it. Vivi's power ranking reflects the capability of someone who has operated under that constraint and has, apparently, managed.`,
		...
		'shiriels-missing-retainer-improv-and-real': `Shiriel's Missing Retainer (improv and real) is missing in two registers simultaneously: in the improv fiction, it is a plot device; in reality, Shiriel's retainer was actually lost. The dual ontology makes this retainer unique in the relics index — it exists in performance and in fact.`,
		...
		'communess-communist-ness': `CommuNess (Communist Ness) is Ness operating under communist ideology — a metaverse variant defined by political philosophy. The Ness who emerged from a communist framework makes different decisions than the standard Ness.`,
		...
		'kenneth-ivary-jaydas-creepy-old-teacher-who-can-swim-350-miles-in-a-day': `Kenneth Ivary is Jayda's creepy old teacher who can swim 350 miles in a day. The swimming capability is the specific supernatural element. The creepy teacher framing provides the relational context. The 350 miles is the detail that cannot be ignored.`,
		...
		'gorbus-in-florence-where-is-he-now': `Gorbus in Florence (where is he now?) is Gorbus in an Italian city, with the parenthetical expressing genuine uncertainty about his current location. The question is part of the documentation. Gorbus was in Florence. Nobody is sure where Gorbus is now.`,
		...
		// Additional metaverse variants
		'among-us-in-real-life': `Among Us In Real Life is the social deduction game transposed to physical reality — a metaverse variant where the mechanics of impostor-finding, task-completing, and emergency-meeting-calling operate in the actual world. The color coding is retained. The trust issues are amplified.`,
		'arnold-murder-mystery': `Arnold Murder Mystery is a murder mystery scenario set in Arnold House — the dorm as crime scene, with residents as suspects. The residential context means everyone knows each other, which makes the deception both easier and harder. Someone in Arnold House did it.`,
		'cursed-simpcest-photo-why-is-this-just-the-lin': `The Cursed SImpcest photo (why is this just the Lin?) is a specific photograph that has achieved metaverse variant status through its cursed nature. The parenthetical question — "why is this just the Lin?" — is the documentation. The photo exists. It features Lins. The reason is unclear and apparently troubling.`,
		'evil-sachin-warm': `Evil Sachin (Warm) is Sachin in his evil configuration, specifically the warm variant — as opposed to Sachin (Cold). The warmth may be thermal, emotional, or moral. Evil Sachin is evil; the warm qualifier distinguishes him from the cold evil Sachin, implying evil comes in temperatures.`,
		'jmo-pushup-porn': `JMo Pushup Porn is a metaverse variant of JMo defined by the pushup porn genre — athletic content in an unexpected context. It is documented without additional annotation. The variant exists.`,
		'midsummer-show': `Midsummer Show is the SImps Midsummer Night's Dream production as a metaverse variant — the show itself given entity status. The Midsummer Set in RAG Courtyard arena is where it lives physically; the Midsummer Show is what happens there when the cast and the forest spirits align.`,
		'sachin-cold': `Sachin (Cold) is Sachin in his cold configuration — the temperature-variant counterpart to Evil Sachin (Warm). Whether the cold is emotional, interpersonal, or physical is unspecified. Sachin runs hot and cold. The wiki has documented both.`,
		'simps-actually-couch': `Simps Actually Couch is a metaverse variant that may refer to a specific couch associated with SImps, a Love Actually parody set on a couch, or the couch as the definitive SImps artifact. The couch is the venue and the character simultaneously.`,
		'the-cursed-superfans-show': `The Cursed Superfans Show is a performance event that has achieved cursed status — a show put on by or for superfans that went wrong in a way that left a mark on the metaverse. The curse is the permanent record of what the superfan context produced.`,
		'arnold-murder-mystery': `Arnold Murder Mystery is a murder mystery set in Arnold House, the Stanford dorm. The residential setting makes every neighbor a suspect. The dorm's social architecture — shared floors, communal spaces, known grudges — is the evidence map.`,

		// Smartest Characters
		'buster-of-rod-and-buster': `Buster of Rod and Buster is the Buster half of the Rod and Buster duo, designated as one of the Smartest Characters in the SImps universe. The intelligence is what drives the partnership — Buster provides the strategy, Rod provides whatever Rod provides. The combination works.`,
		'detective-marcel': `Detective Marcel is a detective of significant intelligence — one of the Smartest Characters in the SImps universe. Marcel investigates with the rigor of someone who has already considered explanations you haven't thought of yet. The case is never as simple as it looks to Marcel.`,
		'roger-inventor-kid-genius': `Roger Inventor Kid Genius is Roger from the Mac and Cheese Family in his full form — inventor, child, genius. He is one of the Smartest Characters in the SImps universe and the builder of Roger's Time Machine. The kid genius archetype in the SImps universe is not a figure of comedy. It is a figure of consequence.`,

		// Names & Titles
		'lenteel': `Lenteel is a name or title in the SImps lexicon — documented in the Names & Titles index as a word that carries enough identity to warrant its own page. Whether it is a character name, an alias, or a term is left open. Lenteel exists in the taxonomy.`,
		'monsieur-vanity-fair': `Monsieur Vanity Fair is a French-titled entity associated with Vanity Fair — the magazine, the fair of vanities, or both. The "Monsieur" elevates the Vanity Fair association into a person with a title. Monsieur Vanity Fair may be the same entity as the 100 Floor Vanity Fair Building's proprietor.`,
		'monsieur-nyfw': `Monsieur NYFW is a French-titled figure associated with New York Fashion Week. The title implies European authority operating in an American fashion context. Monsieur NYFW is probably acquainted with Monsieur Vanity Fair — the overlap between Vanity Fair and NYFW is extensive.`,
		'scroties': `Scroties is a name or title in the SImps taxonomy — documented without further annotation. The word exists in the Names & Titles index as a term the SImps universe has found worth preserving. What it refers to is between you and the context.`,
		'selicate-you-wouldnt-understand': `Selicate (You Wouldn't Understand) is a name that comes with a parenthetical dismissal pre-attached. The "You Wouldn't Understand" is not added afterward — it is part of the official title. Selicate is not going to explain. The entry is the explanation.`,
		'skippy-and-dippy': `Skippy and Dippy are a named pair in the Names & Titles index — two characters documented together as a unit. The rhyming names create a tone of playfulness that may or may not reflect the pair's actual temperament in practice.`,
		'squanter-squampert': `Squanter/Squampert is a name with a slash — either two names for the same entity, or a being that operates between two identities simultaneously. The squant- root runs through both. The wiki preserves the slash rather than resolving the ambiguity.`,
		'trx': `TRX is a three-letter name in the Names & Titles index — either an acronym, a name, or a classification that has been compressed to initials. TRX exists in the SImps universe with enough identity to warrant a page and not enough annotation to explain which.`,
	};
